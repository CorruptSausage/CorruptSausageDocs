	...
	<div class='container center'>
		...
		<form action="" method="POST" class="login_form">
			...
			<div>
				...
				Username:
				<br>
				<input id="login_username" type="text" name="name"> <br>

				Password:
				<br>
				<input id="login_password" type="password" class="login_password" style="margin-bottom:10px;" name="password"> <br>

				<button class="login_button" type="submit" value="Log In">Klik hier om in te loggen</button>
